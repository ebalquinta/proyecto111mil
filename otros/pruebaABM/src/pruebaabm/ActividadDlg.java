...
public class ActividadDlg {
    ...
    public void editar(Actividad actividad) {
        ...
        this.alta = false;        
        this.titulo = "Edición: " + actividad.getNombre();
    }
    ...
    public void mostrar(Window parent) {
        ...
        dialogoPrincipal.setPreferredSize(new Dimension(560, 250));
...
//		txtNombre.setDocument(new FiltroTexto(FiltroTexto.ALL,100));
    ...
    //Actualiza los componenetes con los datos del modelo
    private void actualizarComponentes() {
        this.txtNombre.setText(this.actividad.getNombre());
//        this.txtUrl.setText();
//        this.txtFilePath.setText();
    ...
    private void cargarPropiedades() {
        this.actividad.setNombre(this.txtNombre.getText());
    }
