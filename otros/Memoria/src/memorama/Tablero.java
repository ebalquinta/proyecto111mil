...
public class Tablero extends JPanel{
    ...
    /**
     * Inicia juegos
     * - llena las casillas con pares de figuras 
     * @return no tiene
     */
    public void comenzarJuego(){
        ...
        for( int i=0; i< componentes.length ;i++){
            ...
            if( !existe(band[n]) ){//comprueba que figura no este asignada mas de 2 veces                
                ((Casilla)componentes[i]).setFigura(band[n]);
            }else{
                i--;
            }
        }
